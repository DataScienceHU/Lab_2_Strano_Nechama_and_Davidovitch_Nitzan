...
```
The empirical mean of strategy 2 is 3.86 and of strategy 3 is 6313.8. This is a huge differencr since strategy 3 is not at all efficient. We can see this from the ecdf too
since strategy 3 has many many rotations until a successful geuss, as seen in the graph. On the other hand strategy 2 is very efficient and will geuss the correct word in approxamitly 4 turns!
